...
import ch.makery.address.view.FileSaveDialogController;
import ch.makery.address.view.PersonDeleteConfirmDialogController;
...
public class MainApp extends Application {
    ...
    /**
     * Opens a dialog to warn user for delete a person. If the user
     * clicks OK, the changes are saved into the personTable and true
     * is returned.
     *
    ...
    /**
     * Opens a dialog to show user for save file. If the user
     * clicks OK, the changes are saved into the *.xml and true
     * is returned.
     *
     * @param *.xml to be edited
     * @return true if the user clicked OK, false otherwise.
     */
    ...
    /**
     * Opens a dialog to show about. If the user
     * clicks OK, true
     * is returned.
     *
     * @return true if the user clicked OK, false otherwise.
